...
class BankSystem {
    ...
    public byte luhnAlgorithm(String number) {
    ...
    public boolean isValidNumber(String recipient) {
    ...
    public boolean isValidRecipient(Card card, Optional<Card> optRecipientCard) {
