...
public class GenerateKeys {
    ...
    /**
     * Generates public and private keys in files by path: MyKeys/publicKey, MyKeys/privateKey
     *
     * @return generated java.security.KeyPair that was written in the files
     */
